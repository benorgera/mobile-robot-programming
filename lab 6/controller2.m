classdef controller2 < handle
    ...
    methods
        function obj = controller2(traj, sleep, tdelay, feedback, debug, sim, tow)
...
%             if ~initi
            ...
            figure
            plot(obj.tArr, obj.wArr, obj.traj.timeArray, obj.traj.wArray)
            
            figure
            plot(obj.tArr, obj.vArr, obj.traj.timeArray, obj.traj.VArray)
